        ...
        <div className="mt-10 grid grid-cols-1 gap-8 gap-y-10 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12">
          {projets.map((projet) => {
            ...
            <article key={projet.slug}>
              <Link href={`/projets/${projet.slug}`} className="group block outline-none focus-visible:ring-2 focus-visible:ring-[#f36b21] focus-visible:ring-offset-2 focus-visible:ring-offset-[#f3f0eb]">
