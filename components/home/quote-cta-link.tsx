...
export default function QuoteCtaLink({
  ...
  return (
    <Link
      href={href}
      className={cn(
        'group inline-flex items-center rounded-full border-2 border-[#f36b21] bg-[#f36b21] text-white transition-[padding,background-color,border-color] duration-600 ease-smooth hover:border-[#ff7a33] hover:bg-[#ff7a33] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f36b21]/60 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent',
        size === 'compact'
    ...
    >
      ...
      <span
        className={cn(
          'mx-2 h-[2px] bg-current transition-[width] duration-600 ease-smooth',
          size === 'compact'
      ...
      <ArrowRight
        className={cn(
          'shrink-0 transition-transform duration-600 ease-smooth group-hover:translate-x-0.5',
