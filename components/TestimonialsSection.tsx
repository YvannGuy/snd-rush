      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="text-center">
            <div className="text-4xl md:text-5xl font-bold text-[#F2431E] mb-2">4.9/5</div>
            <div className="text-lg text-gray-600">Note moyenne</div>
          </div>
          <div className="text-center">
            <div className="text-4xl md:text-5xl font-bold text-[#F2431E] mb-2">50</div>
            <div className="text-lg text-gray-600">événements</div>
          </div>
          <div className="text-center">
            <div className="text-4xl md:text-5xl font-bold text-[#F2431E] mb-2">100%</div>
            <div className="text-lg text-gray-600">satisfaits</div>
          </div>
        </div>
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12">
          {currentTestimonials.map((testimonial, index) => (
            <div
              key={testimonial.id}
              className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-[1.02] hover:-translate-y-1"
            >
              {/* Quote */}
              <div className="mb-8">
