...
function BookSuccessContent() {
  ...
  const texts = {
    fr: {
      ...
      nextStepsDesc: 'Vous recevrez un email de confirmation avec tous les détails. Le solde restant sera demandé 1 jour avant votre événement.',
    ...
    en: {
      ...
      nextStepsDesc: 'You will receive a confirmation email with all the details. The remaining balance will be requested 1 day before your event.',
