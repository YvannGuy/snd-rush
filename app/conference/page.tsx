...
export default function ConferencePage() {
  ...
  // Ouvrir le chat simplifié avec packKey 'conference' si activé
  useEffect(() => {
    // Nouveau système simplifié
    if (process.env.NEXT_PUBLIC_USE_SIMPLIFIED_CHAT === 'true') {
      const handleOpenChat = () => {
        window.dispatchEvent(new CustomEvent('openChatWithPack', { detail: { packKey: 'conference' } }));
      };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-[180px] sm:pt-[190px]">
        <PackDetailContent packId="9" language={language} />
      </main>
