...
useEffect(() => {
    ...
    const loadClientData = async () => {
      setLoadingData(true);
      try {
        const { orders: ordersData, reservations: reservationsData } = await adminFetch<{
          orders: any[];
          reservations: any[];
        }>(`/api/admin/clients?email=${encodeURIComponent(clientEmail)}`);
    ...
    loadClientData();
  }, [user, clientEmail, isAdmin, checkingAdmin]);
