  ...
  'enceinte-active-vs-passive': {
    ...
    en: {
      ...
      content: [
        {
          type: 'heading',
          text: 'Introduction: Understanding Active and Passive Speakers'
        },
        {
          type: 'paragraph',
          text: 'When renting sound equipment for your event, you\'ll face a fundamental choice: active or passive speaker? This decision directly impacts sound quality, ease of installation and your event budget. SoundRush Paris guides you in this crucial choice.'
        }
      ]
    }
  },
  'micro-filaire-vs-sans-fil': {
    ...
    en: {
      ...
      content: [
        {
          type: 'heading',
          text: 'Introduction: Wired or Wireless Microphone?'
        },
        {
          type: 'paragraph',
          text: 'The choice between wired and wireless microphone is crucial for the success of your event. Each type has its advantages and constraints. SoundRush Paris helps you make the right choice according to your needs.'
        }
      ]
    }
  },
  'calculer-puissance-sonore-evenement': {
    ...
    en: {
      ...
      content: [
        {
          type: 'heading',
          text: 'Introduction: Why Calculate Sound Power?'
        },
        {
          type: 'paragraph',
          text: 'Choosing the right sound power is essential to guarantee optimal audio quality during your event. Too weak, the sound will be inaudible. Too strong, you risk saturation and discomfort. SoundRush Paris explains how to calculate the necessary power.'
        }
      ]
    }
  },
  'sonorisation-mariage-guide-complet': {
    ...
    en: {
      ...
      content: [
        {
          type: 'heading',
          text: 'Introduction: Sound System, Key Element of Your Wedding'
        },
        {
          type: 'paragraph',
          text: 'Quality sound is essential for the success of your wedding. From the ceremony to the dance party, each moment requires an adapted configuration. SoundRush Paris guides you in organizing your wedding sound system.'
        }
      ]
    }
  },
  '10-erreurs-eviter-location-sono': {
    ...
    en: {
      ...
      content: [
        {
          type: 'heading',
          text: 'Introduction: Avoid Rental Pitfalls'
        },
        {
          type: 'paragraph',
          text: 'Renting sound equipment may seem simple, but many mistakes can compromise your event. SoundRush Paris lists the 10 most common mistakes and how to avoid them.'
        }
      ]
    }
  },
  'budget-sonorisation-evenement-2025': {
    ...
    en: {
      ...
      content: [
        {
          type: 'heading',
          text: 'Introduction: Understanding Sound System Prices'
        },
        {
          type: 'paragraph',
          text: 'The sound system budget can vary considerably depending on your needs. SoundRush Paris details 2025 prices and factors that influence rental costs.'
        }
      ]
    }
  }
