...
const contactFR: ContactCopy = {
  ...
  form: {
    sections: {
      ...
      files: 'Documents techniques (PDF, DWG)',
    },
    labels: {
      name: 'Nom complet',
      ...
      message: 'Message / besoins spécifiques',
      fileDrop: 'Déposez votre brief ou plan (PDF, DWG, PNG)',
      fileHint: '10 Mo max',
      browse: 'Parcourir',
    ...
    servicesOptions: ['Son', 'Lumière', 'Écran LED', 'Vidéo', 'Régie audiovisuelle'],
    selectServices: 'Sélectionnez vos prestations',
...
const contactEN: ContactCopy = {
  ...
  form: {
    sections: {
      ...
      files: 'Technical documents (PDF, DWG)',
    },
    labels: {
      name: 'Full name',
      ...
      message: 'Message / specific needs',
      fileDrop: 'Drop your brief or plan (PDF, DWG, PNG)',
      fileHint: '10 MB max',
      browse: 'Browse',
    ...
    servicesOptions: ['Sound', 'Lighting', 'LED wall', 'Video', 'Show control'],
...
const contactIT: ContactCopy = {
  ...
  form: {
    sections: {
      ...
      files: 'Documenti tecnici (PDF, DWG)',
    },
    labels: {
      name: 'Nome completo',
      ...
      message: 'Messaggio / esigenze specifiche',
      fileDrop: 'Carica il brief o il planimetrico (PDF, DWG, PNG)',
      fileHint: 'Max 10 MB',
      browse: 'Sfoglia',
...
const contactES: ContactCopy = {
  ...
  form: {
    sections: {
      ...
      files: 'Documentos técnicos (PDF, DWG)',
    },
    labels: {
      ...
      message: 'Mensaje / necesidades específicas',
      fileDrop: 'Sube tu brief o plano (PDF, DWG, PNG)',
      fileHint: 'Máx. 10 MB',
      browse: 'Explorar',
    ...
    servicesOptions: ['Sonido', 'Iluminación', 'Pantalla LED', 'Vídeo', 'Regiduría técnica'],
...
const contactZH: ContactCopy = {
  ...
  form: {
    ...
    labels: {
      ...
      message: '留言 / 特殊需求',
      fileDrop: '上传 brief 或平面图 (PDF, DWG, PNG)',
      fileHint: '最大 10 MB',
      browse: '选择文件',
    ...
    servicesOptions: ['音响', '灯光', 'LED 大屏', '视频', '舞台统筹'],
